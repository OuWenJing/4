...
{ 
  ...
  switch ( pkt->clusterId )
  {
    case TEMP_HUMI_CLUSTERID://是温湿度数据命令码
        ...
        Tem_hum_Buf[0]=pkt->cmd.Data[0]/10 + 0x30;
        Tem_hum_Buf[1]=pkt->cmd.Data[0]%10 + 0x30;
        ...
        Tem_hum_Buf[2]=pkt->cmd.Data[1]/10 + 0x30;
        Tem_hum_Buf[3]=pkt->cmd.Data[1]%10 + 0x30;
        printf("Humidity=%d%%\r\n",pkt->cmd.Data[1]);//串口打印        
        //OLED_P8x16Str(0,6,ShowHumiBuf);//OLED屏显示  
        SendToWiFiNetwork(&Tem_hum_Buf[0],4);
    break;
  }
}
/*********************************************************************
