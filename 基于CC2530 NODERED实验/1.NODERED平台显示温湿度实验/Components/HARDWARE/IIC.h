...
#define SCL_PIN           P0_2//P0_6
#define SDA_PIN           P0_3//P0_7

#define SCL_HIGH()        P0_2 = 1;P0_2 = 1;//P0_6 = 1;P0_6 = 1;
#define SCL_LOW()         P0_2 = 0;P0_2 = 0;//P0_6 = 0;P0_6 = 0;

#define SDA_HIGH()        P0_3 = 1;P0_3 = 1;//P0_7 = 1;P0_7 = 1;;
#define SDA_LOW()         P0_3 = 0;P0_3 = 0;;//P0_7 = 0;P0_7 = 0;;

#define SCL_STATE()      P0_2//P0_6
#define SDA_STATE()      P0_3//P0_7
